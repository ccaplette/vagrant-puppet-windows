#Source derived from Rob Reynolds (#ferventcoder) https://github.com/ferventcoder/vagrant-windows-puppet/blob/master/boxes/shared/shell/InstallPuppetFromMSI.ps1
